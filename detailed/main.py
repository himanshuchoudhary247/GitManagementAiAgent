...
def main():
    ...
    use_gitrepo = True  # Set to False to use local directory
    git_repo_url = 'https://github.com/himanshuchoudhary247/demo-auth-repo'
    clone_path = './cloned_repo'
    local_dir_path = '/Users/sudhanshu/demo-auth-repo/demo-auth-repo/'
    
    # Hardcoded requirement for testing
