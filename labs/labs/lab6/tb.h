...
// Testbench (tb) module definition for Lab 6.
// It instantiates the NPU, drives/monitors reset, interrupt, and the new micro-start signal,
...
public:
    ...
    // Event to signal an interrupt was received.
